...
function viewResult(){
    ...
    if(result.status === 'success'){
        document.getElementById('result').innerHTML += ` <h1> <em>${result.status}!!</em><br>Congratulations on finding falcone. King shan is mighty pleased.</h1>
                                                       <h2> <div>Planet found: ${result.planet_name}!</div>   
